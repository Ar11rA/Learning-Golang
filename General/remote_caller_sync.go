...
func makePostRequest(remoteURL string, buf *bytes.Buffer) string {
...
func main() {
	...
	res1 := makePostRequest("http://localhost:3000/ping", requestTemplate1)
	res2 := makePostRequest("http://localhost:3000/ping", requestTemplate2)
	res3 := makePostRequest("http://localhost:3000/ping", requestTemplate3)
	log.Println(res1)
	log.Println(res2)
	log.Println(res3)
}
